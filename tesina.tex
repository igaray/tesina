...
+\begin{verbatim}
+- Empujamos el codigo fuente por un pipeline y corremos un conjunto
+  fijo de transformacion sucesivamente hasta que al final emitimos
+  codigo ensamblador o algun otro lenguaje destino.
+  En el camino frecuentemente necesitamos leer y actualizar algun
+  estado. Por ejemplo, podriamos actualizar la tabla de tipos
